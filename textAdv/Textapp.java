...
public class Textapp {
	...
	public static void main(String[] args){
		...
		expo1 = ("You are floating through the stars in an escape pod, you look at your holo-display to see an old barge. "
		...
		expo2 = ("Once you are in the ship, your pod is surrounded by people. You have seen their outfits before but can't place where they are from. "
		...
		expo3 = ("'Where are you from?', the captain says. You however, have no clue who you are or where you came from. "
